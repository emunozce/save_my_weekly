            ...
            <footer className="bg-green-500 grid grid-cols-1 grid-rows-5 sm:grid-cols-2 sm:grid-rows-3 w-auto">
                ...
                <div className="row-start-2 sm:col-start-1 sm:row-start-2 self-center justify-self-center ">
                    <ul className="flex flex-col justify-center items-center">
                        <li>
                            <Link className="text-slate-900" isBlock href="/">
                                Save My Weekly
                            </Link>
                        </li>
                        <li>
                ...
                <h1 className="text-slate-800 row-start-3 sm:col-start-2 sm:row-start-1 self-center justify-self-center font-extrabold text-xl">
                    About
                </h1>
                    ...
                    <ul className="flex flex-col justify-center items-center">
                        <li>
                            <Link
                                ...
                                isBlock
                                isExternal
                                href="https://github.com/emunozce/Save_My_Weekly"
                                showAnchorIcon
                            >
                                Github Repo
                            </Link>
                ...
                <div className="text-slate-900 row-start-5 sm:row-start-3 sm:col-span-2 self-center justify-self-center">
                    Save My Weekly ©2024 Made by emunozce
                </div>
            </footer>
        </div>
    );
